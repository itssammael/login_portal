    ...
    >
        ...
        >
            <div
                ...
                :class="[
                    toast.type === 'success' ? 'bg-cream-100/95 border-emerald-300 text-gray-900' : '',
                    toast.type === 'error' ? 'bg-cream-100/95 border-rose-300 text-gray-900' : '',
                    toast.type === 'warning' ? 'bg-cream-100/95 border-amber-300 text-gray-900' : '',
                    toast.type === 'info' ? 'bg-cream-100/95 border-cream-500 text-gray-900' : '',
                ]"
            >
                <!-- Toast Icon -->
                <div class="shrink-0 pt-0.5">
                    ...
                    <div
                        ...
                        class="size-8 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center shadow-xs"
                    >
                    ...
                    <div
                        ...
                        class="size-8 rounded-xl bg-rose-100 text-rose-700 flex items-center justify-center shadow-xs"
                    >
                        <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                    ...
                    <div
                        ...
                        class="size-8 rounded-xl bg-amber-100 text-amber-700 flex items-center justify-center shadow-xs"
                    >
                        <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                    ...
                    <div
                        v-else
                        class="size-8 rounded-xl bg-forest-100 text-forest-900 flex items-center justify-center shadow-xs"
                    >
                        <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">

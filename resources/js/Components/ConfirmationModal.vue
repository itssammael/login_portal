...
<template>
    <Modal
        ...
        @close="close"
    >
        <div class="bg-cream-200 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <div class="flex flex-row justify-end px-6 py-4 bg-cream-200/90 border-t border-cream-500/30 text-end">
            <slot name="footer" />
        </div>
    </Modal>
</template>

    ...
    <div>
        ...
        <div class="h-dvh w-full bg-cream-300 flex overflow-hidden">
            ...
            <div class="flex-1 flex flex-col min-h-0 overflow-hidden pt-14 md:pt-0">
                <!-- Page Heading (Slot) -->
                <header v-if="$slots.header" class="border-b border-gray-200/80 px-6 py-4 shrink-0 shadow-2xs">
        ...
        <DialogModal :show="showingAnnouncementModal" @close="closeAnnouncementModal">
            <template #title>
                <div class="flex items-center space-x-3 text-gray-900 font-bold">
                    <div class="p-2 bg-forest-800/75 text-emerald-200 rounded-xl">
                        <img src="/assets/imgs/icons/promotion.png" alt="broadcast_icon" class="w-5">
                    </div>
